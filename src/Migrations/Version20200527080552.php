 ...
 */
final class Version20200527080552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE housing_id housing_id INT NOT NULL');
        $this->addSql('ALTER TABLE document CHANGE housing_id housing_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE housing_id housing_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE document CHANGE housing_id housing_id INT DEFAULT NULL');
